...
DECLARE
BEGIN    
    IF :new.miasto = 'Poz' THEN
    
    INSERT INTO sprzedaz@vm_link(id_sprzedaz,id_produkt,id_klient,id_prac,
...
BEGIN    
    ...
    IF kod_pocztowy > 59999 THEN
    
    INSERT INTO zdarzenia@VM_LINK(id_zdarzenia, id_klient, typ_sprawcy, uwagi) 
...
(czy_b IN NUMBER, imie IN VARCHAR2, nazwisko IN VARCHAR2, 
 ...
 nr_klienta   NUMBER(6);
 kod_pocztowy NUMBER(5);
 CURSOR znajdz IS SELECT id_klient, kod_pocz FROM klienci where kod_pocz>59999;
 BEGIN
